      ...
      <div className="relative bg-white p-8 rounded-lg shadow-xl w-full max-w-md mx-auto mt-64">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center justify-center">
            <button type="submit" className="bg-pink-600 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline">Sign Up</button>
          </div>
        </form>
        <p className="text-center text-gray-500 text-md mt-2">
          Already have an account? <a href='/' className="text-pink-600 cursor-pointer text-md hover:underline">Log in</a>
        </p>
      </div>
    </>
  );
